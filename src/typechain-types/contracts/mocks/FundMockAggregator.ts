...
export interface FundMockAggregatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aggregator"
      | "confirmAggregator"
...
export interface FundMockAggregator extends BaseContract {
  connect(runner?: ContractRunner | null): FundMockAggregator;
  waitForDeployment(): Promise<this>;

  interface: FundMockAggregatorInterface;
