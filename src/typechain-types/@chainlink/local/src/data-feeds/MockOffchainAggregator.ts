...
export interface MockOffchainAggregatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "decimals"
      | "getAnswer"
...
export interface MockOffchainAggregator extends BaseContract {
  connect(runner?: ContractRunner | null): MockOffchainAggregator;
  ...
  updateMinAndMaxAnswers: TypedContractMethod<
    [_minAnswer: BigNumberish, _maxAnswer: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "updateMinAndMaxAnswers"
  ): TypedContractMethod<
    [_minAnswer: BigNumberish, _maxAnswer: BigNumberish],
    [void],
    "nonpayable"
